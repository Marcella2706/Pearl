      ...
      <div className="w-[90%] max-w-[1440px] mx-auto flex flex-col gap-15 md:gap-10">
        <div className="md:w-[13.2rem] md:h-[5.6rem]">
          <div className="flex items-center gap-3">
            ...
            />
            <h2 className="text-6xl md:text-8xl font-extrabold tracking-tight text-foreground">
              Jivika
            </h2>
          </div>
        </div>
          ...
          <div className="flex justify-between w-full gap-8 md:flex-row md:gap-14 items-start flex-wrap md:flex-nowrap">
            <div className="flex-none w-80 md:w-68 p-5 rounded-lg border-2 border-dashed border-accent flex items-center gap-3 mr-80">
              ...
              <div className="flex flex-col gap-4">
                <p className="max-w-78.25 text-xl md:text-base font-normal text-foreground">
                  Our Portfolios
                </p>
              </div>
            </div>
                  ...
                  >
                    ...
                    <ul className="list-none flex flex-col gap-3">
                      {l.links.map((link, idx) => (
                        <li
                          key={idx}
                          className="text-foreground-muted text-base font-normal cursor-pointer relative group transition-colors hover:text-foreground"
                        >
                          {link}
